   ...
   const col1 = [
      {
         ...
         scale: [0.00095, 0.001, 0.001],
         position: [-0.002, -0.092, 0]
      },
      {
   ...
   const col4 = [
      {
         ...
         scale: [0.00092, 0.001, 0.001],
         position: [-0.001, -0.097, 0]
      },
      {
