       ...
       >
         <ViroNode key={`${target}card`}>
           ...
           >
             ...
             {nowTracking && <ARMakeObject {...props} style={style} _changeObject={_changeObject} playAnim={playAnim} show3D={show3D} show32D={show32D} selected={selected} column={column} objIndex={objIndex} />}
           </ViroNode>
         </ViroNode>
       </ViroARImageMarker>
     </ViroNode>
